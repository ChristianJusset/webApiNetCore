...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class GenerosControllerTests : BasePruebas
    {
        ...
        public async Task ObtenerTodosLosGeneros()
        {
            ...
            contexto.Genero.Add(new Genero() { Nombre = "Género 1" });
            contexto.Genero.Add(new Genero() { Nombre = "Género 2" });
        ...
        public async Task ObtenerGeneroPorIdExistente()
        {
            ...
            contexto.Genero.Add(new Genero() { Nombre = "Genero 1" });
            contexto.Genero.Add(new Genero() { Nombre = "Genero 2" });
            await contexto.SaveChangesAsync();
        ...
        public async Task CrearGenero()
        {
            ...
            var contexto2 = ConstruirContext(nombreBD);
            var cantidad = await contexto2.Genero.CountAsync();
        ...
        public async Task ActualizarGenero()
        {
            ...
            var contexto2 = ConstruirContext(nombreBD);
            var controller = new GenerosCustomController(contexto2, mapper);

            var generoCreacionDTO = new GenerActualizacionDTO() { Nombre = "Nuevo nombre" };
            ...
            var existe = await contexto3.Genero.AnyAsync(x => x.Nombre == "Nuevo nombre");
        ...
        public async Task BorrarGenero()
        {
            ...
            var contexto3 = ConstruirContext(nombreBD);
            var existe = await contexto3.Genero.AnyAsync();
