...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class PeliculasControllerTests : BasePruebas
    {
        private string CrearDataPrueba()
        {
            ...
            {
                new Pelicula(){Titulo = "Película 1", FechaEstreno = new DateTime(2010, 1,1), EnCines = false, Poster = "aaa"},
                new Pelicula(){Titulo = "No estrenada", FechaEstreno = DateTime.Today.AddDays(1), EnCines = false, Poster = "aaa"},
                new Pelicula(){Titulo = "Película en Cines", FechaEstreno = DateTime.Today.AddDays(-1), EnCines = true, Poster = "aaa"}
            };
        ...
        public async Task FiltrarPorGenero()
        {
            ...
            var generoId = contexto.Genero.Select(x => x.Id).First();
