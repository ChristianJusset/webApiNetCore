...
namespace NetCoreApi.Controllers.V2
{
    ...
    public class AutoresController : ControllerBase
    {
        ...
        public async Task<ActionResult<AutorLibroDTO>> Get(int id)
        {
            ...
            var dto = mapper.Map<AutorLibroDTO>(autor);
            return dto;
        }
        ...
        {
            var autores = await context.Autor.Where(autorBD => autorBD.Nombre.Contains(nombre)).ToListAsync();
        ...
        {
            var existeAutorConElMismoNombre = await context.Autor.AnyAsync(x => x.Nombre == autorCreacionDTO.Nombre);
